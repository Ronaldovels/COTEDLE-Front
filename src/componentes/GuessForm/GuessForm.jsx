...
function GuessForm() {
  ...
  const fetchDailyCharacter = async () => {
    try {
      const response = await fetch("https://characterdle-api.onrender.com/character/cote/daily");
      const data = await response.json();
      setDailyCharacter(data);

      const lastCharacterResponse = await fetch("https://characterdle-api.onrender.com/character/cote/last");
  ...
  const fetchSuggestions = async (query) => {
    ...
    try {
      ...
      const response = await fetch(`https://characterdle-api.onrender.com/character/cote?name=${query}&exactMatch=false`);
      const data = await response.json();
  ...
  const fetchCharacterDetails = async (name) => {
    try {
      ...
      const response = await fetch(`https://characterdle-api.onrender.com/character/cote?name=${name}&exactMatch=true`);
      const data = await response.json();
